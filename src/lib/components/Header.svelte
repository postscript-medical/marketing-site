    ...
    <a href="/" aria-label="Postscript medical" class="site-head__brand">
      ...
      >
        ...
        <g transform="matrix(.99656 0 0 .99656 -324.19 -61.47)">
          ...
          />
          <polygon class="cls-1" points="805.66 389.8 728.01 389.8 727.99 381.76 805.66 381.76" />
          <polygon class="cls-1" points="823.18 446.8 710.5 446.8 710.49 438.76 823.17 438.76" />
          <polygon class="cls-1" points="805.7 475.31 727.99 475.31 727.96 467.26 805.69 467.26" />
          <rect class="cls-1" x="710.76" y="410.26" width="112.14" height="8.04" />
          <rect class="cls-1" x="736.55" y="532.63" width="60.57" height="8.04" />
          <polygon class="cls-1" points="820.38 572.04 713.38 572.04 713.3 564 820.29 564" />
          <path
            class="cls-1"
...
<style>
  ...
  .mobile-decoration {
    padding: var(--size_200) var(--size_400);
    background-color: var(--color_light);
    box-shadow: 0 0 var(--size_200) rgba(0, 0, 0, 0.15);
  }
