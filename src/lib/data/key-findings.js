...
export default {
  homePage: [keyFindings[0], keyFindings[1], keyFindings[2]],
  researchPage1: [keyFindings[2], keyFindings[4], keyFindings[5]],
  researchPage2: [keyFindings[6], keyFindings[7], keyFindings[8]],
