<script lang="ts">
  ...
  import SectionContributors from "$lib/components/SectionContributors.svelte";
  import SectionEffectiveness from "$lib/components/SectionEffectiveness.svelte";
